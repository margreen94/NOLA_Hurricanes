...
plt.xlabel("Date Recorded", fontsize=30)
plt.ylabel("High Tide (feet)", fontsize=30)
plt.title("High Tide Levels of Lake Pontchartrain 2007-2020", fontsize=30)
...
plt.xlabel("Date Recorded", fontsize=30)
plt.ylabel("Low Tide (feet)", fontsize=30)
plt.title("Low Tide Levels of Lake Pontchartrain 2007-2020", fontsize=30)
...
plt.xlabel("Date Recorded", fontsize=30)
plt.ylabel("Average Tide (feet)", fontsize=30)
plt.title("Average Tide Levels of Lake Pontchartrain 2007-2020", fontsize=30)
...
plt.xlabel("Date Recorded", fontsize=30)
plt.ylabel("Tide Levels (feet)", fontsize=30)
plt.title("February Tide Flucuation of Lake Pontchartrain", fontsize=30)
...
plt.ylabel('Temperature (degrees F)', fontsize=16)
